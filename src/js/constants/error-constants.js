module.exports = Object.freeze({
  DELETE_ARTICLE_ERROR_PREFIX: 'Error deleting article',
  GET_ARTICLES_ERROR_PREFIX: 'Error getting saved articles',
  GET_USER_PROFILE_ERROR_PREFIX: 'Error getting user’s profile',
